...
//     try {
//       // Kiểm tra xem quốc gia đã được thêm vào danh sách yêu thích hay chưa
...
//
//                                       setState(() {
//                                         _isFavorite  = true; // Đánh dấu là đã thêm vào yêu thích
//                                       });
//                                     } catch (error) {
//                                       ScaffoldMessenger.of(context).showSnackBar(
...
//                                   } else {
//                                     try {
//                                       // Lấy reference của document cần xóa từ Firestore
//                                       QuerySnapshot querySnapshot = await _firestore
//                                           .collection('favourite_countries')
...
//                                         await _firestore.collection('favourite_countries').doc(doc.id).delete();
//                                       });
//
//                                       ScaffoldMessenger.of(context).showSnackBar(
...
//
//                                       setState(() {
//                                         _isFavorite  = false; // Bỏ đánh dấu yêu thích
//                                       });
//                                     } catch (error) {
//                                       ScaffoldMessenger.of(context).showSnackBar(
